...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="mt-[150px] mb-[100px] flex items-center  w-full overflow-hidden max-sm:pt-[70px] max-sm:h-auto max-sm:min-h-screen max-sm:pb-8">
      ...
      {/* Quick Navigation */}
      <div className="flex items-center w-full overflow-hidden overflow-y-auto max-sm:pt-[70px] max-xl:mt-[50px] max-sm:h-auto max-sm:min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-20 text-black mt-[50px] max-xl:mt-0">
