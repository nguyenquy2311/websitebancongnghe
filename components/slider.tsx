            ...
            <Slider {...settings} ref={sliderRef}>
              {projects.map((project, idx) => (
                <div key={idx} className="px-0">
                 ...
                 <Link
                        href="/about"
                        className="flex m-auto underline absolute bottom-[0px] text-[#0D7490] translate-x-[-50%] left-[50%] items-center rounded font-quicksand font-medium text-3xl leading-6 tracking-[0.001em] text-white transition-all duration-300 ease-in-out"
                      >
                        Tất cả
                      </Link>
        </div>
